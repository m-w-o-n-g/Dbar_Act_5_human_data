function [A1,A2,B1,B2,C1,C2,D1,D2,theta,r_th,a,M_pts,rmax] = Fourier_coefficients_gen_MODIFIED(coords, Perim,L,Ldiv2)

% This code was originally written by Jennifer Mueller, and has been
% modified by Melody Alsaker for use with D-bar with a Deep Learning prior.
